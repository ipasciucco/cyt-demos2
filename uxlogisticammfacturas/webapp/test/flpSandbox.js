		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Facturas",
									"targetURL": "#comcytzmmportalproveedoresfacturas2021111116-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcytzmmportalproveedoresfacturas2021111116-display": {
								"semanticObject": "comcytzmmportalproveedoresfacturas2021111116",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cyt.zmmportalproveedoresfacturas2021111116",
									"url": sap.ui.require.toUrl("com/cyt/zmmportalproveedoresfacturas2021111116")
								}
							}
						}
					}
